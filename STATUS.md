...
- A small executable consistency check covering the native bundles, classification artifacts, mixed-control decompositions, evidence and artifact schemas, machine-readable control boundaries, control-boundary mapping maturity metadata, witness digests, and seed OSCAL projections.
